 ...
 <div class="box">
    <form action="cadastroponto.php" method="POST">
         <div class="container">
            ...
            <div class="input">
                <input type="text" name="emailponto" id="email" class="inputUser" required>
                <label for="email" class="labelinput">Email</label>
            </div>
            <br>
            <br>
            <div class="input">
                <input type="password" name="senhaponto" id="senha" class="inputUser" required>
            ...
            <br>
            <div class="input">
                <input type="date" name="fundacao" id="fundacão" class="inputUser" required>
            ...
            <br>
            <input type="submit" name="submit_recycling_center" id="submit"> 
            <br>
            </div>
            </div>
            <div class="termos">
