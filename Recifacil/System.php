...
<?php
    ...
    $result2 = $conexao->query($sqlshowpedidos);
        ...
        while($user_data = mysqli_fetch_assoc($result2)){
            echo "<tr>";
            echo "<p>Materiais: <td>".$user_data['plastico']." ".$user_data['vidro']." ".$user_data['metal']." ".$user_data['papel']." ".$user_data['elixo']."| Peso médio: ".$user_data['pesomedio']."Kg"."</p></td>";
            echo "<p>Solicitante: <td>".$user_data['nome']."</td></p>";
            echo "<p>Contato: <td>".$user_data['telefone']."</td></p>";
            echo "<p>Cidade: <td>".$user_data['cidade']."</td></p>";
            echo "<p>ID: <td>".$user_data['id']."</td></p><br><br>";
        }
        ?>
