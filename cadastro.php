<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $result = mysqli_query($conexao, "INSERT INTO endereco(cep, cidade, estado, bairro, rua, numero, complemento, fk_endereco) VALUES ('$cep', '$cidade', '$estado', '$bairro', '$rua', '$numero', '$complemento', '$fk_endereco')");
